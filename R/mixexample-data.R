...
#'@keywords datasets
#'@references Saini et al. (2018). Nat Commun 9(1): 4397.
#' (\href{https://gymreklab.com/2018/03/05/snpstr_imputation.html})
#'@source \href{https://github.com/ice4prince/mixIndependR/tree/main/data}
#'@examples
#'data(mixexample)
