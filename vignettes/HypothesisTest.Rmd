...
ggplot(dfX2,aes(x=x,y=P1(x)))+
  ...
  ggtitle("Cumulative Probability Funciton of Chi Squares for No. of Heterozygous Loci")+
...
ggplot(dfX22,aes(x=x,y=P2(x)))+
  geom_line()+
  geom_hline(yintercept = 0.95,color="Red")+
  ggtitle("Cumulative Probability Funciton of Chi Squares for No. of Shared Alleles")+
  xlab("Chi-square")+ylab("1-p-value")
```
